            ...
            <form method="POST" action="{{ route('books.update', $book) }}" enctype="multipart/form-data">
                ...
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-4">
                    ...
                    <div class="mb-4 col-span-1">
                        ...
                        <x-input value="{{ $book->title }}" id="title" class="block mt-1 w-full" type="text"
                    ...
                    <div class="mb-4 col-span-1">
                        ...
                        <x-input value="{{ $book->author }}" id="author" class="block mt-1 w-full" type="text"
                            name="author" />
                        @error('author')
                ...
                <div class="grid lg:grid-cols-3 grid-cols-1 gap-4">
                    ...
                    <div class="mb-4 col-span-1">
                        ...
                        <x-input value="{{ $book->publisher }}" id="publisher" class="block mt-1 w-full" type="text"
                            name="publisher" />
                        @error('publisher')
                    ...
                    <div class="mb-4 col-span-1">
                        ...
                        <x-input value="{{ $book->year_published }}" id="year_published" class="block mt-1 w-full"
                            type="number" name="year_published" />
                    ...
                    <div class="mb-4 col-span-1">
                        ...
                        <select name="gender_id" id="gender_id" class="block mt-1 w-full rounded-lg border-gray-300">
                            <option value="{{ $book->gender_id }}">{{ $book->gender_name }}</option>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description" rows="3" class="form-input rounded-md shadow-sm mt-1 block w-full">{{ $book->description }}</textarea>
                ...
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-4">
                    ...
                    <div class="mb-4 col-span-1">
                        <center>
                            <img class="w-60 h-80" src="{{ asset($book->image) }}" alt="">
                        </center>
                    </div>
                    ...
                    <div class="mb-4 col-span-1">
                        ...
                        <x-label class="mt-3" for="file" :value="__('File:')" />
