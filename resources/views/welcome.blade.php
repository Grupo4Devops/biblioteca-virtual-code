        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">
                    HOLA MUNDO A World of Knowledge at Your Fingertips</h1>
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div class="container mx-auto py-14">
                <div class="max-w-screen-md mb-4 lg:mb-15">
                    <h2 id="team" class="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">About Us
                    </h2>
                    <p class="text-gray-500 sm:text-xl dark:text-gray-400">Our virtual library was designed
                        and developed by a team of skilled developers with years of experience in creating innovative
                        and user-friendly software solutions. Led by our head developer, our team worked tirelessly to
                        create a library system that would make it easy and intuitive for users to access and read their
                        favorite books online.</p>
                </div>

                <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                    <div
                        class="px-12 py-8 transition-colors duration-300 transform bg-white border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:bg-gray-900">
                        <div class="flex flex-col sm:-mx-4 sm:flex-row">
                            <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                                src="https://avatars.githubusercontent.com/u/92609752?v=4" alt="">
                            ...
                            <div class="mt-4 sm:mx-4 sm:mt-0">
                                ...
                                <p class="mt-2 text-gray-500 capitalize group-hover:text-gray-300">Scrum
                                    Master</p>
                            </div>
                        </div>

                        <p class="mt-4 text-gray-500 capitalize group-hover:text-gray-300">Scrum Master facilitates the
                            Scrum process and
                            ensures that the team is aligned with its principles, removes impediments, and helps the
                            team to improve
                            continuously.</p>
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:-mx-4 sm:flex-row">
                            <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                                src="https://avatars.githubusercontent.com/u/69329983?v=4" alt="">
                            ...
                            <div class="mt-4 sm:mx-4 sm:mt-0">
                                ...
                                <p class="mt-2 text-gray-500 capitalize group-hover:text-gray-300">Product
                                    Owner</p>
                            </div>
                        </div>

                        <p class="mt-4 text-gray-500 capitalize group-hover:text-gray-300">Product Owner: bridges the
                            gap between stakeholders and the team, leading the product vision and ensuring the team
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:-mx-4 sm:flex-row">
                            <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                                src="https://avatars.githubusercontent.com/u/97114827?v=4" alt="">
                        ...
                        <p class="mt-4 text-gray-500 capitalize group-hover:text-gray-300">Experienced professionals
                            who bring technical expertise to develop quality software products.</p>
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:-mx-4 sm:flex-row">
                            <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                                src="https://avatars.githubusercontent.com/u/58397625?v=4" alt="">
                        ...
                        <p class="mt-4 text-gray-500 capitalize group-hover:text-gray-300">Creative individuals who
                            focus on user needs and design interfaces that are intuitive, visually appealing, and
                            user-friendly.</p>
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:-mx-4 sm:flex-row">
                            <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300"
                                src="https://avatars.githubusercontent.com/u/70664928?v=4" alt="">

                            <div class="mt-4 sm:mx-4 sm:mt-0">
                                <h1
                                    class="text-xl font-semibold text-gray-700 capitalize md:text-2xl group-hover:text-white">
                                    Sebastian Padilla</h1>
